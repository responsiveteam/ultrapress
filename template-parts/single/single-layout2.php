 ...
 * @package UltraPress
 */
$post_order = get_theme_mod( 'ultrapress_post_content_reorder', apply_filters('ultrapress_post_content_reorder_defaults','featured_image,title,meta_tag,content,social_share,coments,navigation'));
...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	foreach ($post_explodes as $post_explode):
		...
		apply_filters( 'ultrapress_post_reorder_sections', $post_explode );
	endforeach; 
	?>
