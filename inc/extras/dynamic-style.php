...
?>
        ...
        { color: <?php echo ultrapress_esc_color($acolor) ?>;}
    <?php
    }
    if ($ahover) {
    ?>
...
a.blog-btn.link:hover
        { color: <?php echo ultrapress_esc_color($ahover) ?>;}
    <?php
    }
    ...
    ?>
        #ultrapress-breadcrumb a,#ultrapress-breadcrumb .current,.woocommerce nav.woocommerce-breadcrumb, .woocommerce nav.woocommerce-breadcrumb a, .woocommerce nav.woocommerce-breadcrumb span, .woocommerce .breadcumb-section .title-banner-wrapper nav.woocommerce-breadcrumb a{
    ...
    ?>
        #ultrapress-breadcrumb .delimiter, .woocommerce .woocommerce-breadcrumb span.delimiter{
        color: <?php echo ultrapress_esc_color($banner_styles['bread-sep-color']) ?>;
        }
    <?php
    }
    if (!empty($banner_styles['bread-hover'])) {
    ?>
        #ultrapress-breadcrumb a:hover, .woocommerce nav.woocommerce-breadcrumb a:hover, .woocommerce .breadcumb-section .title-banner-wrapper nav.woocommerce-breadcrumb a:hover{
    ...
    /* Blockquote Styles */
    $bquote_font = json_decode(get_theme_mod('ultrapress_bquote_font_family', '{"font":"Lato","regularweight":"regular","italicweight":"italic","boldweight":"regular","category":"sans-serif"}'), true);
    if ($bquote_font['boldweight'] == 'regular') {
        unset($bquote_font['boldweight']);
        $bquote_font['boldweight'] = 'normal';
    }
    $bquote_font_size = get_theme_mod('ultrapress_bquote_font_size', 19);
    ...
    /* Preformatted Styles */
    $preform_font = json_decode(get_theme_mod('ultrapress_preform_font_family', '{"font":"Lato","regularweight":"regular","italicweight":"italic","boldweight":"regular","category":"sans-serif"}'), true);
    if ($preform_font['boldweight'] == 'regular') {
        unset($preform_font['boldweight']);
        $preform_font['boldweight'] = 'normal';
    }
    $preform_font_size = get_theme_mod('ultrapress_preform_font_size');
    ...
    $header_border = get_theme_mod('ultrapress_header_layouts_border');
    $header_border_color = get_theme_mod('ultrapress_header_layouts_border_color');
    $header_bg_color = get_theme_mod('ultrapress_header_layouts_bg_color');
    $header_bg_image = get_theme_mod('ultrapress_header_layouts_bg_img');

    $nav_color = get_theme_mod('ultrapress_header_nav_text_color');
    $nav_hcolor = get_theme_mod('ultrapress_header_nav_text_hcolor');

    $nav_font = json_decode(get_theme_mod('ultrapress_nav_font_family', '{"font":"Lato","regularweight":"regular","italicweight":"italic","boldweight":"regular","category":"sans-serif"}'), true);
    ...
    $nav_lheight = get_theme_mod('ultrapress_nav_line_height');

    $nav_drop_font = json_decode(get_theme_mod('ultrapress_nav_drop_font_family', '{"font":"Lato","regularweight":"regular","italicweight":"italic","boldweight":"regular","category":"sans-serif"}'), true);
    if ($nav_drop_font['boldweight'] == 'regular') {
        unset($nav_drop_font['boldweight']);
        $nav_drop_font['boldweight'] = 'normal';
    }
    $nav_drop_size = get_theme_mod('ultrapress_nav_drop_font_size');
    $nav_drop_lheight = get_theme_mod('ultrapress_nav_drop_line_height');
    ...
    $btn_border_radius = get_theme_mod('ultrapress_purchase_btn_bradious');
    ...
    ?>
        ...
        <?php if ($btn_border) { ?>
            border-color: <?php echo ultrapress_esc_color($btn_border); ?>;
        <?php } ?>
    ...
    ?>
        ...
        <?php if ($header_border_color) { ?>
            border-bottom-color: <?php echo ultrapress_esc_color($header_border_color); ?>;
        <?php } ?>
        <?php if ($header_bg_color) { ?>
            background-color: <?php echo ultrapress_esc_color($header_bg_color); ?>;
        <?php } ?>
    ...
    ?>
        body .navbar-nav>li> ul li a, body .site-header .ultrapress-default-header.is-sticky .navbar-nav>li> ul li a{
    ...
    ?>
        ...
        body .site-header .ultrapress-default-header.is-sticky .navbar-nav>li>a,
        body .navbar-nav>li>a,
    ...
    ?>
        ...
        .ultrapress-default-header.is-sticky .mini-cart a:hover svg, 
        .ultrapress-default-header.is-transparent .mini-cart a:hover svg,
        .mini-cart a:hover svg,
        body.single-layout1 .site-header .ultrapress-default-header .mini-cart a:hover svg,
        .ultrapress-default-header.is-sticky .search-icon:hover svg, 
        .ultrapress-default-header.is-transparent .search-icon:hover svg,
        .search-icon:hover svg,
        body.single-layout1 .site-header .ultrapress-default-header .search-icon:hover svg{
        fill: <?php echo ultrapress_esc_color($nav_hcolor); ?>;
        }
        ul.navbar-nav>li.menu-item>a:before, ul.navbar-nav>li.menu-item.current_page_item>a:before, ul.navbar-nav>li.menu-item.current_page_parent>a:before,.ultrapress-default-header.is-sticky nav.navbar ul.navbar-nav>li.menu-item>a:before, .link:before, body.single-layout1 .site-header .ultrapress-default-header .mini-cart:hover span.header-cart-count, .ultrapress-default-header.is-transparent .mini-cart:hover span.header-cart-count{
        background-color: <?php echo ultrapress_esc_color($nav_hcolor); ?>;
        }
    <?php
    }
    ...
    /* archive meta hover */
    $meta_hcolor = get_theme_mod('ultrapress_meta_hcolor');
    if ($meta_hcolor) {
    ?>
        .meta-info > span a:hover {
        color: <?php echo ultrapress_esc_color($meta_hcolor); ?>;
        }
    <?php
    }
    ...
    ?>
        ...
        <?php if ($mini_btn_bg) { ?>
            background-color: <?php echo ultrapress_esc_color($mini_btn_bg); ?>;
        <?php }
        if ($mini_btn_txt) { ?>
            color: <?php echo ultrapress_esc_color($mini_btn_txt); ?>;
        <?php } ?>
        }
    <?php
    }
    ...
    ?>
        ...
        <?php if ($mini_btn_hbg) { ?>
            background-color: <?php echo ultrapress_esc_color($mini_btn_hbg); ?>;
        <?php }
        if ($mini_btn_htxt) { ?>
            color: <?php echo ultrapress_esc_color($mini_btn_htxt); ?>;
        <?php } ?>
        }
    <?php
    }
...
<?php
    ...
    $css = ob_get_clean();
    $css = ultrapress_css_strip_whitespace(apply_filters('ultrapress_dynamic_css', $css));
