...
function ultrapress_woocommerce_scripts() {
	...
	wp_enqueue_style( 'ultrapress-woocommerce-style', get_template_directory_uri() . '/assets/css/woo'.$min.'.css' );
}
add_action( 'wp_enqueue_scripts', 'ultrapress_woocommerce_scripts',10);
