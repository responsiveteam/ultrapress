...
$wp_customize->add_setting(
	'ultrapress_shop_setting_heading',
	array(
		'transport' => 'refresh',
...
$wp_customize->add_setting(
	'ultrapress_shop_display_layout',
	array(
		'default' => 'grid',
		'transport' => 'refresh',
...
$wp_customize->add_setting(
	'ultrapress_shop_sidebar_layout',
	array(
...
$wp_customize->add_control(
	new Ultrapress_Sidebar_Dropdown_Custom_Control(
		$wp_customize,
		'ultrapress_shop_sidebar',
		array(
			'label'    		=> esc_html__('Choose Sidebar', 'ultrapress'),
			'section'  		=> 'ultrapress_shop_setting_section',
			'active_callback'=>'ultrapress_single_shop_sidebar_cb',
		)
	)
);
