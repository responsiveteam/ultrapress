...
$wp_customize->add_control( 'ultrapress_breadcrumb_separator', 
	array(
		...
		'section' => 'ultrapress_breadcrumb_section',
		'type' => 'text',
		'active_callback' => 'ultrapress_bread_button_cb'
	)
); 
$wp_customize->add_setting( 'ultrapress_bread_sep_color',
	array(
		'transport' => 'refresh',
...
$wp_customize->add_control( 
	new Ultrapress_Customize_Alpha_Color_Control( 
		$wp_customize, 'ultrapress_bread_sep_color',
		array(
			'label' => esc_html__( 'Breadcrumb Separator Color', 'ultrapress' ),
			'section' => 'ultrapress_breadcrumb_section',
			'show_opacity' => false,
			'active_callback' => 'ultrapress_bread_button_cb'
		)
