...
/*
Load Elementor Header Style in wp_head
*/
add_action( 'wp_enqueue_scripts', function() {
    $header_page_id = get_theme_mod( 'ultrapress_custom_header' );
    if ( class_exists( '\Elementor\Core\Files\CSS\Post' ) && !empty($header_page_id)) {
