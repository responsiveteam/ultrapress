...
class ultrapress_recent_post_slider_widgets extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		<?php
		echo wp_kses_post( $args['before_widget'] );
		$ultrapress_recent_post_slider_post_title = isset($instance['ultrapress_recent_post_slider_post_title']) ? $instance['ultrapress_recent_post_slider_post_title']:'';
		$ultrapress_recent_post_slider_post_per_page = isset($instance['ultrapress_recent_post_slider_post_per_page']) ? $instance['ultrapress_recent_post_slider_post_per_page']:'';
		$hide_recent_post_slider_post_date = isset($instance['hide_recent_post_slider_post_date']) ? $instance['hide_recent_post_slider_post_date']:'';
		?>
